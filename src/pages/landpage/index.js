      ...
      <Wrapper>
        <div className="presentation-cont">
          ...
          <div className="pre-cont-2">
            ...
            <p className="descrip">
                Se presenta con la idea de ofrecer una Plataforma de múltiples
                servicios, como contratación de servicios publicitarios, adquisición
                de productos vía previo acuerdo y otros más en desarrollo.
            </p>
            <div className="button-group-land">
              <button type="button">Presentaciones</button>
              <button type="button">Servicios</button>
              <button type="button">Trabajos</button>
            </div>
          </div>
        </div>
        <br />
        <div className="information-cont">
          <div className="widget-1">
            <CardInfo
              image={publicaccess}
              title={generalAspects[0].title}
              descrip={generalAspects[0].descrip}
            />
          </div>
          <div className="widget-2">
            <CardInfo
              image={responsive}
              title={generalAspects[1].title}
              descrip={generalAspects[1].descrip}
            />
          </div>
          <div className="widget-3">
            <CardInfo
              image={trueNew}
              title={generalAspects[2].title}
              descrip={generalAspects[2].descrip}
            />
          </div>
          <div className="widget-4">
            <CardInfo
              image={offers}
              title={generalAspects[3].title}
              descrip={generalAspects[3].descrip}
            />
          </div>
        </div>
      </Wrapper>
